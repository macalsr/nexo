...
public class RefreshSessionManager {
    ...
    public String rotate(String rawToken) {
        return rotateAndResolve(rawToken).refreshToken();
    }

    public RefreshRotationResult rotateAndResolve(String rawToken) {
        ...
        return new RefreshRotationResult(currentSession.userId(), newRawToken);
    }
